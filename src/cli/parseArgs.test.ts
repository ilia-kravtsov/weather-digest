...
describe('parseArgs', () => {
  ...
  it('throws if city value is missing', () => {
    expect(() =>
      parseArgs(['--city', '--days', '3']),
    ).toThrow('Необходимо указать город после --city');
  });
